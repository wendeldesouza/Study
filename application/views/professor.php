...
<body>
	...
	<div class="IconPage">
		<img class="" src="<?php echo base_url('assets/img/prof.png'); ?>">
		<p>
			Professor
		</p>
	</div>
	<div class="Crud">
		<form role="search" class="navbar-form">
			<div class="form-group has-feedback">
				<input type="text" class="form-control" placeholder="Pesquisar Professor" id="Pesquisa" />
	...
	<div id="myModal" class="modal">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h2>
					<img class="imgpro" src="<?php echo base_url('assets/img/prof.png'); ?>">
